...
<html lang="en">
  <head>
    ...
    <title>React: Understanding hooks</title>
    <link
  ...
  <body>
    <header
      ...
      style="background-color: #1262d1;"
    >
      <h1 class="text-light text-center"></h1>
      <div class="btn-group mt-2" role="group" aria-label="Buttons">
        <a href="../index.html" class="btn btn-light">Home</a>
        <a href="./index.html" class="btn btn-light">Blog</a>
      </div>
    </header>

    <section class="py-3 px-5"></section>

    <footer
      class="p-3 d-flex flex-column justify-content-center align-items-center"
      style="background-color: #1262d1;"
    >
      <span class="text-light">&copy; Pedro Isac</span>
      <div>
        <a
        ...
        >
        <a
          href="https://github.com/pedro-isacss"
          target="_blank"
          class="text-light mx-2"
          >GitHub</a
        >
